...
export async function POST(request: NextRequest) {
  try {
    ...
    const emailResponse = await resend.emails.send({
      ...
      to: [email],
      subject: 'Welcome to Fire Safety Log',
      html: htmlContent,
    });
...
<head>
  ...
  <title>Welcome to Fire Safety Log</title>
</head>
        ...
        <table role="presentation" style="max-width: 600px; width: 100%; background-color: #ffffff; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
          ...
          <tr>
            <td style="padding: 40px;">
              ...
              <p style="margin: 0 0 16px 0; color: #4a4a4a; font-size: 16px; line-height: 1.6;">
                Congratulations on setting up <strong>${organisationName}</strong> on Fire Safety Log! Your organisation is now ready to manage fire safety compliance, inspections, and records.
              </p>
